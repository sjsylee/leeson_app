...
exports.requestCoupangCategoryPrediction = void 0;
...
const requestCoupangCategoryPrediction = async (params, accessKey, secretKey) => {
    const controller = new AbortController();
    const timeout = setTimeout(() => {
        controller.abort();
    }, REQUEST_TIMEOUT_MS);
    try {
        const authorization = (0, auth_1.createCoupangAuthorizationHeader)({
            accessKey,
            secretKey,
            method: "POST",
...
exports.requestCoupangCategoryPrediction = requestCoupangCategoryPrediction;
