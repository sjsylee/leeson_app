...
exports.getCpCategoryMeta = void 0;
const client_1 = require("../db/client");
const validation_1 = require("./validation");
const getCpCategoryMeta = async ({ catCode }) => {
    let status;
    let result = [];
    const categoryCode = (0, validation_1.sanitizePositiveInteger)(catCode, "catCode");
    const { dats } = await (0, client_1.withDatabase)("Category", async (conn) => {
        const dataRows = (await conn.query(`SELECT name,
...
exports.getCpCategoryMeta = getCpCategoryMeta;
